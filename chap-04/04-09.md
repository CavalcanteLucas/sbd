...
Aqui, *ID_empregado* é uma chave para a tabela <em><b>gerente</b></em>, significando que cada empregado tem, no máximo, um gerente. A cláusula **foreign key** exige que cada gerente também seja um empregado. Explique exatamente o que acontece quando uma tupla na relação <em><b>gerente</b></em> é excluída.
