...
docker compose down -v; docker compose up small --build
docker compose exec -e HOME="/dbt_" -u "$(id -u):$(id -g)" small sqlfluff lint dbt_/models/chap-03/03-01 --verbose 


## Instruções para configuração do laboratório (simplificado)
