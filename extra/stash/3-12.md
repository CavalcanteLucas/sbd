...
**f)** Exclua todas as tuplas de $\text{realiza}$ correspondentes a qualquer seção de qualquer curso com a palavra "database" como parte do título; ignore maiúsculas e minúsculas.
