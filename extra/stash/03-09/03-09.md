...
Considere o banco de dados relacional da [Figura 3.19](#Figura-3.19), onde as chaves primárias estão sublinhadas. Dê uma expressão SQL para cada uma das seguintes consultas.
